...
bool HGE_Impl::Input_GetEvent(hgeInputEvent *event)
{
...
void HGE_Impl::Input_GetMousePos(float *x, float *y)
{
	*x=Xpos; *y=Ypos;
}
...
bool HGE_Impl::Input_IsMouseOver()
{
	return bMouseOver;
}
...
bool HGE_Impl::Input_KeyUp(int key)
{
	return (keyz[key] & 2) != 0;
}

char* HGE_Impl::Input_GetKeyName(int key)
{
	return KeyNames[key];
}

int HGE_Impl::Input_GetKey()
{
	return VKey;
}

int HGE_Impl::Input_GetChar()
{
	return Char;
}
